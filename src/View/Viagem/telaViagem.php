...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="/View/css/styleViagem.css" />
    ...
    <aside class="side-bar">
        ...
        <article class="side-bar-middle">
            <a href="/menu/veiculo" class="side-bar-icon">
                <img src="/View/img/Icons/veiculo.png" class="img-icon" alt="Menu de Veiculos">
            </a>
            <a href="/menu/gasto" class="side-bar-icon">
                <img src="/View/img/Icons/gastoTodos.png" class="img-icon" alt="Menu de todos os Gastos">
            </a>
        </article>
            ...
            <div class="container-row">
                ...
                <div class="acoes-gastos">
                    <a href="/menu/viagem/gastos?idViagem=<?=$viagem->getId()?>">
                        <button class="btn-opcao">
                            <img class="img-icon" src='/View/img/Icons/gasto.png' alt=''>
                        </button>
                    </a>
                </div>
                <?php endif; ?>
...
<script src="/View/js/funcoesViagem.js"></script>
</body>
</html>