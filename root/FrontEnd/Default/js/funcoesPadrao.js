    ...
    return templateErroNaoEncontrado = `
        <div class="container-erro">
            <figure class="container-img-erro">
                <img alt="Icone indicando um erro de que algo não foi encontrado. Ilustração" src="/root/FrontEnd/images/mascote/RaioSozinho.png">
            </figure>
    ...
    return templateErroPermisso = `
        <div class="container-erro">
            <figure class="container-img-erro-permissao">
                <img alt="Icone indicando um erro de que o usuário não possui acesso à está página. Ilustração" src="/root/FrontEnd/images/mascote/RaioBarrado.png">
            </figure>
...
function criaTemplateErroInterno(erro) {
    return templateErroInterno = `
        <div class="container-erro">
            <figure class="container-img-erro">
                <img alt="Icone indicando um erro de que o usuário não possui acesso à está página. Ilustração" src="/root/FrontEnd/images/mascote/RaioDuvida.png">
            </figure>
