...
class Router{
    ...
    private function decideView()
    {
        ...
        // /ajuda/{idUsuario}
        elseif ($this->url[0] == "ajuda" && $this->url[1] == (int)$this->url[1] && count($this->url) == 2){
            require "src/View/Ajuda/telaAjuda/telaAjuda.html";
        }
        // /viagem/{idViagem}
        ...
        // /users
        elseif ($this->url[0] == "users" && count($this->url) == 1){
            require "src/View/Admin/telaUsuarios/telaUsuarios.html";
        }
        // /confirmar
